...
void GameScene_02::createMenu()
{
	auto btn_Pause = MenuItemImage::create("Game/btn_pause.png","Game/btn_pause_std.png",
		CC_CALLBACK_1(GameScene_02::menuPause, this));
	auto menu = Menu::createWithItem(btn_Pause);
	menu->setPosition(50,visibleSize.height - 30);
	this->addChild(menu);
}

void GameScene_02::menuPause(Ref* pSender)
{
	Director::getInstance()->pushScene(Pause::createScene(2));
}

Scene* GameScene_02::createScene()
{
	// 'scene' is an autorelease object
	auto scene = Scene::create();
	// 'layer' is an autorelease object
	auto layer = GameScene_02::create();
...
void GameScene_02::createSlider()
{
...
void GameScene_02::menuCloseCallback(Ref* pSender)
{
